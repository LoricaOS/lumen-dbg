...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=lumen-dbg                     # herald package id (== repo name)
NAME="Lumen diagnostics"         # human-readable name
DESTBIN=bin/lumen-probe          # where the binary installs (verbatim runtime path)
